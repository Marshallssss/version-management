...
- `codex/futuristic-ui` 提供新版浅色工作台、石墨导航、统一项目树/机台/比较和弹窗；尚未合并主分支。项目名称与简介集中在顶部，中文和已有业务规则保留。
...
- 启动方式不变，不需要额外 Migration。本分支不表示 Windows Production Integration Pending 已完成。
