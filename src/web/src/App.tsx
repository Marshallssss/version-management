        ...
        {selectedNavigation.available ? (
          <div className="content-grid">
            ...
            {activePage === 'projects' && <>
              ...
              {isAuthenticated && selectedProjectId && projectDetail.data && <ProjectWorkspace detail={projectDetail.data} focusedVersionId={focusedVersionId} focusedBaselineId={focusedBaselineId} isAdmin={isAdmin} onSuccess={setSuccessMessage} />}
              <div hidden>
              ...
              {projectDetail.data && <ProjectWorkspace detail={projectDetail.data} focusedVersionId={focusedVersionId} focusedBaselineId={focusedBaselineId} isAdmin={isAdmin} onSuccess={setSuccessMessage} />}
