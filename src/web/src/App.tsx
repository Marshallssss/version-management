      ...
      <main>
        ...
        {selectedNavigation.available ? (
          <div className="content-grid">
            ...
            {activePage === 'machines' && <MachineWorkspace key={selectedProjectId ?? ''} projectId={selectedProjectId ?? ''} canWrite={canWrite} selectedMachineId={selectedMachineId} onSelectMachine={setSelectedMachineId} onOpenVersion={(projectId, versionId) => { setSelectedProjectId(projectId); localStorage.setItem('confighub.selected-project-id', projectId); setFocusedBaselineId(''); setFocusedVersionId(versionId); setActivePage('projects') }} onSuccess={setSuccessMessage} />}
          </div>
        ) : (
