        ...
        {selectedNavigation.available ? (
          <div className="content-grid">
            ...
            {activePage === 'projects' && <>
              ...
              {isAuthenticated && selectedProjectId && projectDetail.data && <ProjectWorkspace detail={projectDetail.data} focusedVersionId={focusedVersionId} focusedBaselineId={focusedBaselineId} isAdmin={isAdmin} isSuperAdmin={isSuperAdmin} onSuccess={setSuccessMessage} />}
              <div hidden>
            ...
            {activePage === 'machines' && <MachineWorkspace projects={projects.data ?? []} selectedMachineId={selectedMachineId} onSelectMachine={setSelectedMachineId} onOpenVersion={(projectId, versionId) => { setSelectedProjectId(projectId); localStorage.setItem('confighub.selected-project-id', projectId); setFocusedBaselineId(''); setFocusedVersionId(versionId); setActivePage('projects') }} onSuccess={setSuccessMessage} />}
          </div>
        ) : (
