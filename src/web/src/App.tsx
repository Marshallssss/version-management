        ...
        {selectedNavigation.available ? (
          <div className="content-grid">
            ...
            {activePage === 'projects' && <>
              ...
              {isAuthenticated && selectedProjectId && projectDetail.data && <ProjectWorkspace key={selectedProjectId} canWrite={canWrite} detail={projectDetail.data} focusedVersionId={focusedVersionId} focusedBaselineId={focusedBaselineId} focusedComponentId={focusedComponentId} focusPatch={focusPatch} isAdmin={isAdmin} isSuperAdmin={isSuperAdmin} onSuccess={setSuccessMessage} />}
              <div hidden>
