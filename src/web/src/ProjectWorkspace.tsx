...
export function ProjectWorkspace({ detail, focusedVersionId, focusedBaselineId, isAdmin, isSuperAdmin, onSuccess }: { detail: ProjectDetail; focusedVersionId?: string; focusedBaselineId?: string; isAdmin: boolean; isSuperAdmin: boolean; onSuccess: (message: string) => void }) {
