...
export const compareBaselines = (leftBaselineId: string, rightBaselineId: string) => request<{ items: Array<{ componentId: string; status: string; componentCode: string; componentName: string; leftVersionId: string | null; leftVersionNumber: string | null; rightVersionId: string | null; rightVersionNumber: string | null }> }>(`/api/v1/baselines/${leftBaselineId}/compare/${rightBaselineId}`)
...
export const getMachineConfiguration = (machineId: string) => request<Array<{ componentId: string; componentCode: string; componentName: string; versionId: string | null; versionNumber: string | null; state: string; stateEffectiveAt: string; knownInstalledAt: string | null }>>(`/api/v1/machines/${machineId}/configuration`)
export const getMachineConfigurationAt = (machineId: string, at: string) => request<{ asOf: string; items: Array<{ componentId: string; componentCode: string; componentName: string; versionId: string | null; versionNumber: string | null; state: string; stateEffectiveAt: string; recordedAt: string; knownInstalledAt: string | null }> }>(`/api/v1/machines/${machineId}/configuration-at?at=${encodeURIComponent(at)}`)
...
export const getMachineDrift = (machineId: string) => request<{ matchStatus: string; riskSeverity: string; items: Array<{ componentId: string; componentCode: string; componentName: string; status: string; expectedVersionId: string | null; expectedVersionNumber: string | null; actualVersionId: string | null; actualVersionNumber: string | null }> }>(`/api/v1/machines/${machineId}/drift`)
export const compareMachines = (leftMachineId: string, rightMachineId: string) => request<{ matchStatus: string; riskSeverity: string; items: Array<{ componentId: string; componentCode: string; componentName: string; status: string; leftVersionId: string | null; leftVersionNumber: string | null; rightVersionId: string | null; rightVersionNumber: string | null }> }>(`/api/v1/machines/${leftMachineId}/compare/${rightMachineId}`)
