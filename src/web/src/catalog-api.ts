...
export const compareMachines = (leftMachineId: string, rightMachineId: string) => request<{ matchStatus: string; riskSeverity: string; items: Array<{ componentId: string; status: string; leftVersionId: string | null; rightVersionId: string | null }> }>(`/api/v1/machines/${leftMachineId}/compare/${rightMachineId}`)
export const compareMachineCurrentToHistory = (machineId: string, at: string) => request<{ matchStatus: string; riskSeverity: string; items: Array<{ componentId: string; status: string; currentVersionId: string | null; historicalVersionId: string | null }> }>(`/api/v1/machines/${machineId}/compare-history?at=${encodeURIComponent(at)}`)
